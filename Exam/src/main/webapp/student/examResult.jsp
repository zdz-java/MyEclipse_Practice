...
<table width="1003" height="485" border="0" cellpadding="0" cellspacing="0" class="centerbg">
  <tr>
	...
	<table width="60%" align="center" cellpadding="10" cellspacing="0" border="1">
      ...
      <tr>
        <td><div align="center">考试姓名:${studentName}</div></td>
        <td><div align="center">考生得分:${GeneralPoint}分</div></td>
      </tr>
      <tr>
        <td colspan="2"><div align="center"><a href="showSubjectAnswer">查看答案</a></div></td>
      </tr>
    </table></td>
    <td width="113">&nbsp;</td>
  </tr>
